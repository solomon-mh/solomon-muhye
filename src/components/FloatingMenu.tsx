...
const FloatingMenu = () => {
  ...
  return (
    <AnimatePresence>
      {scrolled && (
        <motion.div
          className="fixed hidden lg:flex bottom-24 left-1/2 transform -translate-x-3/5 md:-translate-x-1/2 z-50 px-4  md:px-8 py-4 rounded-full shadow-xl backdrop-blur-md bg-white/70 dark:bg-black/40 border border-green-500 dark:border-green-400 space-x-6"
